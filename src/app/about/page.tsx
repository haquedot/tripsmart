        ...
        <div className="flex flex-col items-center justify-center py-20 px-4 min-h-screen">
            <div className="w-full max-w-3xl text-center mb-12">
                ...
                <p className="text-lg text-gray-600 mt-4">
                    At TripSmart, we’re dedicated to enhancing your travel experience by making it smarter and more convenient. Learn more about our journey, mission, and what drives us.
                </p>
            </div>
            ...
            <section className="w-full max-w-4xl bg-white rounded-lg shadow-md p-8 mb-8">
                ...
                <p className="text-gray-700 mt-4">
                    TripSmart is a forward-thinking travel platform designed to simplify and enhance every step of your journey. Whether you're exploring new destinations or planning a business trip, our solutions make it easy, accessible, and smart.
                </p>
            </section>
            ...
            <section className="w-full max-w-4xl bg-white rounded-lg shadow-md p-8">
                ...
                <p className="text-gray-700 mt-4">
                    We're here to help with any questions, feedback, or partnership opportunities. Reach out to us at <a href="mailto:contact@tripsmart.com" className="text-blue-600 hover:underline">contact@tripsmart.com</a>.
                </p>
            </section>
        </div>
    )
